# Test the New Relic meta counter challenge.
# https://gist.github.com/5b287544800f8a6cddf2
#
# $ ruby meta_counter_test.rb
#
# This test file assumes you have a solution.rb file that is stored in the same
# directory as these tests.
# ./tmp/program.rb is auto generated by the test cases.
require 'minitest/autorun'
require 'fileutils'
class MetaCounterTest < Minitest::Test
  ...
  def solution_path
    File.expand_path(File.dirname(__FILE__) + '/solution.rb')
  end
  ...
  def test_standard_lib_class_and_class_method
    output = execute_program('String.try_convert', <<-RB)
    10.times{ String.try_convert("foo") }
    RB
    assert_sig_and_count(output, 'String.try_convert', 10)
  end
